...
<div class="box box-info padding-1">
    ...
    <div class="row g-3">
        ...
        <div class="col-3 ">
            ...
            {!! $errors->first('carrera', '<div class="invalid-feedback">Campo requerido</div>') !!}
        </div>
        <div class="col-3 ">
            {{ Form::label('Nivel') }}
        ...
        <div class="col-3 ">
            ...
            {!! $errors->first('hr_practicas', '<div class="invalid-feedback">Campo requerido</div>') !!}
        </div>
        <div class="row g-3">
        ...
        <div class="col-3 ">
            ...
            {!! $errors->first('tit_proyecto', '<div class="invalid-feedback">Campo requerido</div>') !!}
        </div>
        <div class="row g-3">
        <div class="col-3 ">
            {{ Form::label('Análisis') }}
            ...
            {!! $errors->first('analisis', '<div class="invalid-feedback">Campo requerido</div>') !!}
        </div>
        <div class="row g-3">
        <div class="col-3 ">           
            ...
            {!! $errors->first('obj_proyecto', '<div class="invalid-feedback">Campo requerido</div>') !!}
        </div>
        <div class="col-3 ">
            ...
            {!! $errors->first('des_proyecto', '<div class="invalid-feedback">Campo requerido</div>') !!}
        </div>
        <div class="row g-3">
        <div class="col-3 ">             
            {{ Form::label('Indicador') }}
            {{ Form::text('indicador', $empresariale->indicador, ['class' => 'form-control' . ($errors->has('indicador') ? ' is-invalid' : '')]) }}
            {!! $errors->first('indicador', '<div class="invalid-feedback">Campo requerido</div>') !!}
        </div>
        <div class="col-3 ">
            {{ Form::label('Meta') }}
            {{ Form::text('meta', $empresariale->meta, ['class' => 'form-control' . ($errors->has('meta') ? ' is-invalid' : '')]) }}
            {!! $errors->first('meta', '<div class="invalid-feedback">Campo requerido</div>') !!}
        </div>
        <div class="col-3 ">             
            ...
            {!! $errors->first('presupuesto', '<div class="invalid-feedback">Campo requerido</div>') !!}
        </div>
        <div class="row g-3">
        <div class="col-3 ">             
            {{ Form::label('Medicion') }}
            {{ Form::text('medicion', $empresariale->medicion, ['class' => 'form-control' . ($errors->has('medicion') ? ' is-invalid' : '')]) }}
            {!! $errors->first('medicion', '<div class="invalid-feedback">Campo requerido</div>') !!}
        </div>
        <div class="col-3 ">             
            {{ Form::label('Fuente') }}
            {{ Form::text('fuente', $empresariale->fuente, ['class' => 'form-control' . ($errors->has('fuente') ? ' is-invalid' : '')]) }}
            {!! $errors->first('fuente', '<div class="invalid-feedback">Campo requerido</div>') !!}
        </div>
        <div class="col-3 ">             
            ...
            {!! $errors->first('beneficios', '<div class="invalid-feedback">Campo requerido</div>') !!}
        </div>
        <div class="row g-3">
        <div class="col-3 ">             
            ...
            {!! $errors->first('comentarios', '<div class="invalid-feedback">Campo requerido</div>') !!}
        </div>
        <div class="row g-3">
        <b> <h3>Firmas</h3></b>
        <div class="col-3 "> 
            {{ Form::label('Coordinador carrera') }}
            {{ Form::text('cor_carrera', $empresariale->cor_carrera, ['class' => 'form-control' . ($errors->has('cor_carrera') ? ' is-invalid' : '')]) }}
            {!! $errors->first('cor_carrera', '<div class="invalid-feedback">Campo requerido</div>') !!}
        </div>
        <div class="col-3 "> 
            {{ Form::label('Tutor Empresa') }}
            {{ Form::text('tut_empresa', $empresariale->tut_empresa, ['class' => 'form-control' . ($errors->has('tut_empresa') ? ' is-invalid' : '')]) }}
